...
$('.elem-1__date').html(pageLoadData.elem1.date);
  ...
  $('.elem-2').css('background-image', pageLoadData.elem1.backgroundImg);
  ...
  $('.elem-3').css('background-image', pageLoadData.elem1.backgroundImg);
  ...
  $('.elem-4').css('background-image', pageLoadData.elem1.backgroundImg);
